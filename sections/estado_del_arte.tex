...
\begin{enumerate}
    ...
    \item \textbf{Integración}: Compatibilidad con el backend en Rust
\end{enumerate}
...
\subsection{Estudio de patrones de diseño}
Durante este apartado se va a realizar un estudio de los patrones de diseño más utilizados en el desarrollo de software de código abierto. 
